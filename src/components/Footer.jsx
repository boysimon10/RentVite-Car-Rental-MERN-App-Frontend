...
function Footer() {
  return (
    <div className="bg-white-0 pt-4 sm:pt-10 lg:pt-12 md:mx-[90px] lg:mx-[90px]">
  <footer className="mx-auto max-w-screen-2xl px-4 md:px-8">
    <div className="flex flex-col items-center justify-between gap-4 border-t border-b py-6 md:flex-row">
      ...
      <div className="flex gap-4">
        <a
          href='https://www.instagram.com/s1m0n.27/'
          target="Instagram"
        ...
        <a
          href='https://www.linkedin.com/in/simon-marcel-amad-diouf-9b2819198'
          target="LinkdIn"
          className="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600"
        >
          <svg
        ...
        <a
          href="https://github.com/boysimon10"
          target="Github"
          className="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600"
        >
          <svg
