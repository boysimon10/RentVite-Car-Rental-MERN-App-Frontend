  ...
  const handleAddCar = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.REACT_APP_API_URL}car/addcar`,
        data,
        config
      );
                  ...
                  <form className="w-full lg:max-w-xl" onSubmit={handleAddCar}>
                    ...
                    <div className={`relative flex items-center mt-4`}>
                      ...
                      <input
                        ...
                        min="0"
                        max="6"
                        onChange={(e) => setCapaciteAccueil(e.target.value)}
                ...
                <p className="text-xs text-gray-400 mt-2">
                  PNG and JPG are Allowed.
                    ...
                    <div className="mt-4 md:flex md:items-center">
                      <button
                        type="submit"
                        className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue rounded-lg md:w-1/2 hover:bg-blue-light focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50"
                      >
                        {" "}
                        Ajouter{" "}
                      </button>
